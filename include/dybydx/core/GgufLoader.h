...
namespace DirectLLM {
    ...
    // Values MUST match ggml_type in ggml.h — the previous enum had I8/I16/I32
    // at 16/17/18, which are actually IQ2_XXS/IQ2_XS/IQ3_XXS in ggml, so any
    // IQ-quantized GGUF mis-parsed its tensor sizes.
